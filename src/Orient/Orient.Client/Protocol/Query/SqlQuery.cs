...
namespace Orient.Client.Protocol.Query
{
    ...
    {
        private readonly QueryCompiler _compiler = new QueryCompiler();
        ...
        internal void Set<T>(string fieldName, T fieldValue) {
            ...
            else if (fieldValue is DateTime)
            {
                ...
                var value = (DateTime)((object)fieldValue);
        ...
        internal void Set<T>(T obj) {
            ...
            foreach (var field in document) {
                ...
                // do not set in and out fields
                if (field.Key == "in" || field.Key == "out") continue;
        ...
        private string GenerateDeleteEdgeQuery() {
            ...
            if (_compiler.HasKey(Q.From) && _compiler.HasKey(Q.To)) {
                query += string.Join(" ", Q.Delete, Q.Edge, _compiler.Value(Q.Class), Q.From, _compiler.Value(Q.From),
                    Q.To, _compiler.Value(Q.To));
            }
            else {
